...
import { AlertTriangle, FileX, Trash2, TrendingDown } from "lucide-react";
...
export default function DeletedBillsPage() {
  ...
  return (
    <div className="p-6 pb-16">
      <DashboardBreadcrumb label="บิลที่ถูกลบ" href="/bills/deleted" />
              ...
              <KPICard
                ...
                value={
                  summary.totalDeleted > 0
                    ? summary.totalAmount / summary.totalDeleted
                    : 0
                }
                format="currency"
                icon={FileX}
